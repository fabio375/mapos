        ...
        <div class="sub-page">
            ...
            <section>
                ...
                <?php if (!empty($result->checklist)) : ?>
                    <div class="subtitle">CHECKLIST DO APARELHO</div>
                    <div class="dados">
                        <div style="text-align: justify;">
                            <?= nl2br(html_escape($result->checklist)) ?>
                        </div>
                    </div>
                <?php endif; ?>

                <?php if (!empty($result->senha_celular)) : ?>
                    <div class="subtitle">SENHA DE DESBLOQUEIO</div>
                    <div class="dados">
                        <div style="text-align: justify;">
                            <?= html_escape($result->senha_celular) ?>
                        </div>
                    </div>
                <?php endif; ?>
                            ...
                            <?php
                                ...
                                foreach ($anexos as $a) :
                                    if ($a->thumb) :
                                        ...
                                        $link  = $a->url.'/'.$a->anexo;
                                        echo '<img src="'.htmlspecialchars($link, ENT_QUOTES, 'UTF-8').'" alt="">';
                                    endif;
                                endforeach;
                            ?>
                        </div>
